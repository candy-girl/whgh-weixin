<template>
  <div class="yjwzcontainer"
       v-loading="loading"
       element-loading-text="拼命加载中"
       element-loading-spinner="el-icon-loading"
       element-loading-background="rgba(0, 0, 0, 0.6)">
    <div class="yjwzheaderContainer">
    ...
    <div class="listContainer">
      ...
      <div class="list" v-for="item in listData" @click="goDetail(item)" v-else>
        <div class="left">
          <p class="riverName">{{item.wzName}}</p>
          <p class="second">
            <span>所属企业</span>
            <span>——</span>
...
<script>
  export default {
    ...
    methods: {
      ...
      getList() {
        this.postData('http://115.236.161.140:8090/wechat/getYjwz', {wzName: this.input})
          .then(data => {
            this.loading = false
      ...
      goDetail(item){
        ...
        //   data:item
        // })
        this.$router.push(`/yjwzxq/${item.id}`)
      }
    },
    created () {
      this.getList()
